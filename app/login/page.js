  ...
  return (
    <>
      <div className="main w-full h-auto">
        <div className="container md:px-36 w-full h-[80vh] flex items-center justify-center flex-col">
          <h1 className="text-3xl font-bold">Login to get the amazing Maggi</h1>

          <div>
            <div className="flex flex-col gap-2 h-auto  p-10">
